"""
Production settings for akrionline project.
This file contains production-specific settings for deployment on GoDaddy cPanel.
"""
...
WSGI_APPLICATION = 'akrionline.wsgi.application'
...
ACCOUNT_LOGOUT_ON_GET = False  # Require POST for logout in production
...
# Custom adapter for handling user creation
